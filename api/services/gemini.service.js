...
const geminiMiddleware = async (req, res, next) => {
  const { prompt, age, moral, language, gender, noOfPages } = req.body;
  ...
  // The illustration of the cover page should include a close up and clear image of the face of the child character so as to make it easier for a face swap and the face in the cover page should be looking straight at the reader.
